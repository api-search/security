...
mechanism_count: 3
method: searched
name: Fenergo Authentication
name_suffix: Authentication
oauth_flows:
- clientCredentials
- authorizationCode
overview: Fenergo secures its APIs with oauth2, openIdConnect, apiKey, http, and mutualTLS across 3 declared security schemes, as derived from its OpenAPI definitions. OAuth 2.0 is offered via the clientCredentials and authorizationCode flow(s).
...
- name: HTTPBearer
  ...
  type: http
slug: fenergo-authentication
source_filename: fenergo-authentication.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/fenergo/refs/heads/main/authentication/fenergo-authentication.yml
