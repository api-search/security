...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct 31 22:45:45 2026 GMT
  host: www.fenergo.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Mar  1 23:59:59 2027 GMT
  host: docs.fenergox.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Fenergo, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Fenergo
provider_slug: fenergo
slug: fenergo-domain-security
source_filename: fenergo-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-09-09'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.fenergo.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 31 22:45:45 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: docs.fenergox.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Mar  1 23:59:59 2027 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: api.fenergox.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Mar  1 23:59:59 2027 GMT\n  hsts: null\ndomains:\n- domain: fenergo.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n- domain: fenergox.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/fenergo/refs/heads/main/security/fenergo-domain-security.yml
