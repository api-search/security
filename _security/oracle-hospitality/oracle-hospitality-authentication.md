...
- password
- clientCredentials
overview: Oracle Hospitality secures its APIs with oauth2, http, and apiKey across 4 declared security schemes, as derived from its OpenAPI definitions. OAuth 2.0 is offered via the password and clientCredentials flow(s).
...
source_filename: oracle-hospitality-authentication.yml
