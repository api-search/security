...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Sep 18 09:00:51 2026 GMT
...
overview: 'Domain security posture for Contify, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
