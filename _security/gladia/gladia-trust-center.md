...
overview: Gladia maintains a public trust center documenting SOC 2, ISO 27001, HIPAA, and GDPR compliance.
provider_name: Gladia
provider_slug: gladia
slug: gladia-trust-center
source_filename: gladia-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: searched\nprobe: true\nsource: https://www.gladia.io/security\nurl: https://www.gladia.io/security\ncertifications:\n- SOC 2\n- ISO 27001\n- HIPAA\n- GDPR\nevidence:\n- source: https://www.gladia.io/security\n  keywords:\n  - soc 2\n  - iso 27001\n  - hipaa\n  - trust center\n  - gdpr\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/gladia/refs/heads/main/security/gladia-trust-center.yml
...
- WebSocket
- REST
trust_url: https://www.gladia.io/security
---
