...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Sep 16 12:48:20 2026 GMT
  host: apileague.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for API League, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
