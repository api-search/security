...
- filename: astronomer-agent-token-api-openapi.yml
  format: yaml
  label: Astronomer Agent Token API
  slug: astronomer-agent-token-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/astronomer/refs/heads/main/openapi/astronomer-agent-token-api-openapi.yml
- filename: astronomer-api-token-api-openapi.yml
  format: yaml
  label: Astronomer API Token API
  slug: astronomer-api-token-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/astronomer/refs/heads/main/openapi/astronomer-api-token-api-openapi.yml
...
overview: Astronomer maintains a public trust center documenting SOC 2, PCI DSS, and GDPR compliance.
provider_name: Astronomer
provider_slug: astronomer
slug: astronomer-trust-center
source_filename: astronomer-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-07-18'\nmethod: searched\nprobe: true\nsource: https://trust.astronomer.io/\nurl: https://trust.astronomer.io/\ncertifications:\n- SOC 2\n- PCI DSS\n- GDPR\nevidence:\n- source: https://trust.astronomer.io/\n  keywords:\n  - soc 2\n  - pci dss\n  - trust center\n  - gdpr\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/astronomer/refs/heads/main/security/astronomer-trust-center.yml
