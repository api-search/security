...
overview: 'Domain security posture for LKQ, probed live across 1 host(s) and 1 registrable domain(s). Email/DNS controls: DNSSEC absent, SPF present, DMARC absent.'
provider_name: LKQ
provider_slug: lkq
