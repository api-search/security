...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Nov  6 12:07:50 2026 GMT
...
overview: 'Domain security posture for CloudTalk, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=none).'
