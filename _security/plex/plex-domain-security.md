...
- caa:
  ...
  spf: false
hosts:
- cert_expires: Oct  5 23:16:59 2026 GMT
  host: www.plex.tv
  hsts: true
...
overview: 'Domain security posture for Plex, probed live across 3 host(s) and 2 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.2); 2 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=reject).'
provider_name: Plex
provider_slug: plex
slug: plex-domain-security
source_filename: plex-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-05'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.plex.tv\n  https: true\n  tls_version: TLSv1.2\n  cert_expires: Oct  5 23:16:59 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: developer.plex.tv\n  https: true\n  tls_version: TLSv1.2\n  cert_expires: Oct  5 23:16:59 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: 1-2-3-4.0123456789abcdef0123456789abcdef.plex.direct\n  https: false\ndomains:\n- domain: plex.tv\n  dnssec: true\n  caa:\n  - 0 issue \"amazon.com\"\n  - 0 issue \"digicert.com\"\n  - 0 issue \"letsencrypt.org\"\n  - 0 issue \"pki.goog; cansignhttpexchanges=yes\"\n  - 0 issuewild \"digicert.com\"\n  - 0 issuewild \"pki.goog; cansignhttpexchanges=yes\"\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n- domain: plex.direct\n  dnssec: false\n  caa:\n  - 0 issuewild \"digicert.com\"\n  - 0 issue \";\"\n  - 0 iodef \"mailto:misissue@plex.tv\"\n  - 0 issuewild \"letsencrypt.org\"\
  \n  spf: false\n  dmarc: false\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/plex/refs/heads/main/security/plex-domain-security.yml
