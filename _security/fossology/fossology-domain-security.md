...
- caa: []
  dmarc: false
  dnssec: true
  domain: fossology.org
  spf: true
hosts:
- cert_expires: Sep  6 18:54:28 2026 GMT
  host: www.fossology.org
  hsts: true
  hsts_max_age: 300
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for FOSSology, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC absent.'
provider_name: FOSSology
provider_slug: fossology
slug: fossology-domain-security
source_filename: fossology-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.fossology.org\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep  6 18:54:28 2026 GMT\n  hsts: true\n  hsts_max_age: 300\ndomains:\n- domain: fossology.org\n  dnssec: true\n  caa: []\n  spf: true\n  dmarc: false\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/fossology/refs/heads/main/security/fossology-domain-security.yml
