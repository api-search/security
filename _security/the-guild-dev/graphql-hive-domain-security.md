...
overview: 'Domain security posture for The Guild, probed live across 2 host(s) and 2 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=none).'
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/the-guild-dev/refs/heads/main/security/graphql-hive-domain-security.yml
