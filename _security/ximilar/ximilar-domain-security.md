...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Aug 28 23:04:28 2026 GMT
...
overview: 'Domain security posture for Ximilar, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
