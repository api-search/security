---
api_specs:
- filename: amadeus-reservations-booking-api-openapi.yml
  format: yaml
  label: Amadeus Reservations Booking API
  slug: amadeus-reservations-booking-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/amadeus-reservations/refs/heads/main/openapi/amadeus-reservations-booking-api-openapi.yml
description: ''
domains:
- caa: []
  dmarc: true
