...
- caa: []
  ...
  dmarc_policy: none
  dnssec: false
  domain: isportsapi.com
  spf: true
hosts:
- cert_expires: Aug 23 23:59:59 2026 GMT
  host: www.isportsapi.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Aug 23 23:59:59 2026 GMT
  host: api.isportsapi.com
  hsts: null
  https: true
  tls_version: TLSv1.2
- cert_expires: Aug 23 23:59:59 2026 GMT
  host: api2.isportsapi.com
  hsts: null
  https: true
  tls_version: TLSv1.2
...
overview: 'Domain security posture for iSports API, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
provider_name: iSports API
provider_slug: isports-api
slug: isports-api-domain-security
source_filename: isports-api-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-09'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.isportsapi.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Aug 23 23:59:59 2026 GMT\n  hsts: false\n- host: api.isportsapi.com\n  https: true\n  tls_version: TLSv1.2\n  cert_expires: Aug 23 23:59:59 2026 GMT\n  hsts: null\n- host: api2.isportsapi.com\n  https: true\n  tls_version: TLSv1.2\n  cert_expires: Aug 23 23:59:59 2026 GMT\n  hsts: null\ndomains:\n- domain: isportsapi.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/isports-api/refs/heads/main/security/isports-api-domain-security.yml
