...
- caa: []
  ...
  dnssec: false
  domain: orionisbio.com
  spf: true
hosts:
- cert_expires: Oct 22 02:51:41 2026 GMT
  host: orionisbio.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Orionis Biosciences, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: Orionis Biosciences
provider_slug: orionis-biosciences
slug: orionis-biosciences-domain-security
source_filename: orionis-biosciences-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-04'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: orionisbio.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 22 02:51:41 2026 GMT\n  hsts: false\ndomains:\n- domain: orionisbio.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/orionis-biosciences/refs/heads/main/security/orionis-biosciences-domain-security.yml
