...
overview: 'Domain security posture for PowerPoint, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/powerpoint/refs/heads/main/security/powerpoint-domain-security.yml
