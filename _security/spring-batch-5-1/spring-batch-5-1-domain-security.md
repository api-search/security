---
api_specs:
- filename: spring-batch-5-1-batch-jobs-api-openapi.yml
  format: yaml
  label: Spring Batch 5.1 Batch Jobs API
  slug: spring-batch-5-1-batch-jobs-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/spring-batch-5-1/refs/heads/main/openapi/spring-batch-5-1-batch-jobs-api-openapi.yml
- filename: spring-batch-5-1-health-api-openapi.yml
  format: yaml
  label: Spring Batch 5.1 Health API
  slug: spring-batch-5-1-health-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/spring-batch-5-1/refs/heads/main/openapi/spring-batch-5-1-health-api-openapi.yml
- filename: spring-batch-5-1-metrics-api-openapi.yml
  format: yaml
  label: Spring Batch 5.1 Metrics API
  slug: spring-batch-5-1-metrics-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/spring-batch-5-1/refs/heads/main/openapi/spring-batch-5-1-metrics-api-openapi.yml
description: ''
domains:
- caa:
