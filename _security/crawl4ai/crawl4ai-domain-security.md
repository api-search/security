...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov  5 09:42:37 2026 GMT
  host: crawl4ai.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Sep  6 08:50:28 2026 GMT
  host: gate.crawl4ai.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Sep  6 08:50:28 2026 GMT
  host: api.crawl4ai.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Crawl4AI, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
