...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Dec  4 06:17:11 2026 GMT
...
- cert_expires: Oct 10 23:59:59 2026 GMT
  ...
  https: true
  tls_version: TLSv1.2
- cert_expires: Nov 30 19:27:53 2026 GMT
...
overview: 'Domain security posture for Carvana, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
