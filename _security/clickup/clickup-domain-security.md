...
- cert_expires: Mar 23 23:59:59 2027 GMT
  host: www.clickup.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 15 06:24:43 2026 GMT
...
overview: 'Domain security posture for Clickup, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
