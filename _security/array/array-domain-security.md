...
- cert_expires: Oct  9 13:24:59 2026 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Sep 27 13:10:35 2026 GMT
  host: array.io
  hsts: true
  hsts_max_age: 31536000
  https: true
...
overview: 'Domain security posture for Array, probed live across 2 host(s) and 2 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: Array
provider_slug: array
