...
oauth_flows:
- password
overview: Eightfold AI secures its APIs with oauth2 and http across 2 declared security schemes, as derived from its OpenAPI definitions. OAuth 2.0 is offered via the password flow(s).
...
source_filename: eightfold-ai-authentication.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/eightfold-ai/refs/heads/main/authentication/eightfold-ai-authentication.yml
