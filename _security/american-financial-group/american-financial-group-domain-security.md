...
- cert_expires: Oct 27 02:44:40 2026 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Dec  1 09:01:38 2026 GMT
  host: www.greatamericaninsurancegroup.com
  hsts: true
  hsts_max_age: 63072000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov  9 23:43:43 2026 GMT
  host: api-documentation.gaig.com
  hsts: null
  https: true
  tls_version: TLSv1.3
hosts_probed: 3
...
overview: 'Domain security posture for American Financial Group, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
