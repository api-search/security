...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Sep 30 03:49:53 2026 GMT
  host: clickhouse.com
  hsts: true
  hsts_max_age: 0
  https: true
...
overview: 'Domain security posture for ClickHouse, probed live across 2 host(s) and 2 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: ClickHouse
provider_slug: clickhouse
slug: clickhouse-domain-security
source_filename: clickhouse-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: clickhouse.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep 30 03:49:53 2026 GMT\n  hsts: true\n  hsts_max_age: 0\n- host: api.clickhouse.cloud\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Jan 22 23:59:59 2027 GMT\n  hsts: true\n  hsts_max_age: 0\ndomains:\n- domain: clickhouse.com\n  dnssec: false\n  caa:\n  - 0 issue \"comodoca.com\"\n  - 0 issue \"digicert.com; cansignhttpexchanges=yes\"\n  - 0 issue \"letsencrypt.org\"\n  - 0 issue \"pki.goog; cansignhttpexchanges=yes\"\n  - 0 issue \"ssl.com\"\n  - 0 issuewild \"amazon.com\"\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n- domain: clickhouse.cloud\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/clickhouse/refs/heads/main/security/clickhouse-domain-security.yml
