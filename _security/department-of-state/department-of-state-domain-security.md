...
- cert_expires: Jan 19 23:59:59 2027 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Aug 30 11:00:47 2026 GMT
  host: step.state.gov
  hsts: true
  hsts_max_age: 31536000
  https: true
...
overview: 'Domain security posture for Department of State, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=reject).'
