...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov  5 21:48:41 2026 GMT
  host: www.hubspot.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 17 02:23:10 2026 GMT
  host: developers.hubspot.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 16 21:52:00 2026 GMT
  host: api.hubapi.com
  hsts: true
  hsts_max_age: 31536000
  https: true
...
overview: 'Domain security posture for HubSpot, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 3 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=reject).'
provider_name: HubSpot
provider_slug: hubspot
slug: hubspot-domain-security
source_filename: hubspot-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-09-24'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.hubspot.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov  5 21:48:41 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: developers.hubspot.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov 17 02:23:10 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: api.hubapi.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov 16 21:52:00 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\ndomains:\n- domain: hubspot.com\n  dnssec: true\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n- domain: hubapi.com\n  dnssec: true\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/hubspot/refs/heads/main/security/hubspot-domain-security.yml
