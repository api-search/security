...
oauth_flows: []
overview: Kentik secures its APIs with apiKey across 2 declared security schemes, as derived from its OpenAPI definitions.
provider_name: Kentik
provider_slug: kentik
scheme_count: 2
schemes:
- in: header
  name: email
  parameter: X-CH-Auth-Email
  sources:
  - openapi/kentik-ai-advisor-openapi.json
  - openapi/kentik-alert-policy-openapi.json
  - openapi/kentik-alerting-openapi.json
  - openapi/kentik-as-group-openapi.json
  - openapi/kentik-audit-openapi.json
  - openapi/kentik-bgp-monitoring-openapi.json
  - openapi/kentik-capacity-plan-openapi.json
  - openapi/kentik-cloud-export-openapi.json
  - openapi/kentik-cost-openapi.json
  - openapi/kentik-custom-dimension-openapi.json
  - openapi/kentik-device-openapi.json
  - openapi/kentik-flow-tag-openapi.json
  - openapi/kentik-kmi-openapi.json
  - openapi/kentik-label-openapi.json
  - openapi/kentik-mitigation-openapi.json
  - openapi/kentik-mkp-openapi.json
  - openapi/kentik-notification-channel-openapi.json
  - openapi/kentik-site-openapi.json
  - openapi/kentik-synthetics-openapi.json
  - openapi/kentik-user-openapi.json
  type: apiKey
- in: header
  name: token
  parameter: X-CH-Auth-API-Token
  sources:
  - openapi/kentik-ai-advisor-openapi.json
  - openapi/kentik-alert-policy-openapi.json
  - openapi/kentik-alerting-openapi.json
...
source_filename: kentik-authentication.yml
source_heading: Authentication Profile
source_url: ''
source_yaml: "generated: '2026-07-19'\nmethod: searched\ndocs: https://kb.kentik.com/docs/apis-overview\nnotes: >-\n  Kentik V6 APIs authenticate with two API-key headers on every request:\n  X-CH-Auth-Email (the user's Kentik email) and X-CH-Auth-API-Token (the user's\n  API token from their profile; rotate with the User API ResetApiToken op). No\n  OAuth2 / OIDC. Confirmed against the Kentik KB APIs overview.\nsource: openapi/kentik-ai-advisor-openapi.json, openapi/kentik-alert-policy-openapi.json, openapi/kentik-alerting-openapi.json,\n  openapi/kentik-as-group-openapi.json, openapi/kentik-audit-openapi.json, openapi/kentik-bgp-monitoring-openapi.json,\n  openapi/kentik-capacity-plan-openapi.json, openapi/kentik-cloud-export-openapi.json, openapi/kentik-cost-openapi.json,\n  openapi/kentik-custom-dimension-openapi.json, openapi/kentik-device-openapi.json, openapi/kentik-flow-tag-openapi.json\n  ...\nsummary:\n  types:\n  - apiKey\n  api_key_in:\n  - header\nschemes:\n- name: email\n \
  \ type: apiKey\n  in: header\n  parameter: X-CH-Auth-Email\n  sources:\n  - openapi/kentik-ai-advisor-openapi.json\n  - openapi/kentik-alert-policy-openapi.json\n  - openapi/kentik-alerting-openapi.json\n  - openapi/kentik-as-group-openapi.json\n  - openapi/kentik-audit-openapi.json\n  - openapi/kentik-bgp-monitoring-openapi.json\n  - openapi/kentik-capacity-plan-openapi.json\n  - openapi/kentik-cloud-export-openapi.json\n  - openapi/kentik-cost-openapi.json\n  - openapi/kentik-custom-dimension-openapi.json\n  - openapi/kentik-device-openapi.json\n  - openapi/kentik-flow-tag-openapi.json\n  - openapi/kentik-kmi-openapi.json\n  - openapi/kentik-label-openapi.json\n  - openapi/kentik-mitigation-openapi.json\n  - openapi/kentik-mkp-openapi.json\n  - openapi/kentik-notification-channel-openapi.json\n  - openapi/kentik-site-openapi.json\n  - openapi/kentik-synthetics-openapi.json\n  - openapi/kentik-user-openapi.json\n- name: token\n  type: apiKey\n  in: header\n  parameter: X-CH-Auth-API-Token\n\
  \  sources:\n  - openapi/kentik-ai-advisor-openapi.json\n  - openapi/kentik-alert-policy-openapi.json\n  - openapi/kentik-alerting-openapi.json\n  - openapi/kentik-as-group-openapi.json\n  - openapi/kentik-audit-openapi.json\n  - openapi/kentik-bgp-monitoring-openapi.json\n  - openapi/kentik-capacity-plan-openapi.json\n  - openapi/kentik-cloud-export-openapi.json\n  - openapi/kentik-cost-openapi.json\n  - openapi/kentik-custom-dimension-openapi.json\n  - openapi/kentik-device-openapi.json\n  - openapi/kentik-flow-tag-openapi.json\n  - openapi/kentik-kmi-openapi.json\n  - openapi/kentik-label-openapi.json\n  - openapi/kentik-mitigation-openapi.json\n  - openapi/kentik-mkp-openapi.json\n  - openapi/kentik-notification-channel-openapi.json\n  - openapi/kentik-site-openapi.json\n  - openapi/kentik-synthetics-openapi.json\n  - openapi/kentik-user-openapi.json\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/kentik/refs/heads/main/authentication/kentik-authentication.yml
