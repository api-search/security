...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct 10 13:17:37 2026 GMT
  host: www.denbury.com
  hsts: true
...
overview: 'Domain security posture for Denbury Resources, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Denbury Resources
provider_slug: denbury-resources
slug: denbury-resources-domain-security
source_filename: denbury-resources-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-09-06'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.denbury.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 10 13:17:37 2026 GMT\n  hsts: true\n  hsts_max_age: 2592000\ndomains:\n- domain: denbury.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/denbury-resources/refs/heads/main/security/denbury-resources-domain-security.yml
