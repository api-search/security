...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov  2 12:57:31 2026 GMT
  host: aeternity.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 21 04:22:19 2026 GMT
  host: api-docs.aeternity.io
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Aeternity, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Aeternity
provider_slug: aeternity
slug: aeternity-domain-security
source_filename: aeternity-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-09-12'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: aeternity.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov  2 12:57:31 2026 GMT\n  hsts: false\n- host: api-docs.aeternity.io\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov 21 04:22:19 2026 GMT\n  hsts: false\n- host: mainnet.aeternity.io\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Dec 31 23:59:59 2026 GMT\n  hsts: null\ndomains:\n- domain: aeternity.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n- domain: aeternity.io\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: false\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/aeternity/refs/heads/main/security/aeternity-domain-security.yml
