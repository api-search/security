...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Nov 10 12:30:06 2026 GMT
  host: sendspark.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 12 01:35:27 2026 GMT
  host: help.sendspark.com
  hsts: true
...
overview: 'Domain security posture for Sendspark, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
