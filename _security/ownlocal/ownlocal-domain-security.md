...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Sep 18 00:19:46 2026 GMT
  host: ownlocal.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for OwnLocal, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC absent.'
