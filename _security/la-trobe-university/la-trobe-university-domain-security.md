...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Aug 28 06:43:11 2026 GMT
...
overview: 'Domain security posture for La Trobe University, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
