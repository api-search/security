---
api_specs:
- filename: uclouvain-orthanc-api-openapi.yml
  format: yaml
  label: Orthanc API
  slug: orthanc-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/uclouvain/refs/heads/main/openapi/uclouvain-orthanc-api-openapi.yml
description: ''
domains:
- caa:
