...
overview: ZeroTier maintains a public trust center documenting SOC 2 Type II compliance.
provider_name: ZeroTier
provider_slug: zerotier
slug: zerotier-trust-center
source_filename: zerotier-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-07-21'\nmethod: searched\nprobe: true\nsource: https://trust.zerotier.com/\nurl: https://trust.zerotier.com/\ncertifications:\n- SOC 2 Type II\ncompliance_docs: https://docs.zerotier.com/security/\nnotes: >-\n  ZeroTier is SOC 2 Type II certified per its security documentation. The public Trust Center\n  (trust.zerotier.com) is a JS-rendered portal for requesting compliance documents and SOC 2\n  reports; the SOC 2 Type II claim is sourced from https://docs.zerotier.com/security/.\nevidence:\n- source: https://docs.zerotier.com/security/\n  keywords:\n  - soc 2 type ii\n  - trust center\n- source: https://trust.zerotier.com/\n  keywords:\n  - trust center\n  - compliance certification\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/zerotier/refs/heads/main/security/zerotier-trust-center.yml
...
- Zero Trust
- Infrastructure
trust_url: https://trust.zerotier.com/
---
