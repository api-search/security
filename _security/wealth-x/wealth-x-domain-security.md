...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov  9 15:45:17 2026 GMT
  host: wealthx.com
  hsts: true
...
overview: 'Domain security posture for Wealth-X, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
