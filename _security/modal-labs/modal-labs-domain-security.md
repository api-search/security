...
- cert_expires: Nov 23 13:10:16 2026 GMT
  host: api.modal.com
  hsts: null
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Modal, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Modal
