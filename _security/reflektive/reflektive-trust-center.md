...
overview: Reflektive maintains a public trust center documenting SOC 2, ISO 27001, and GDPR compliance.
provider_name: Reflektive
provider_slug: reflektive
slug: reflektive-trust-center
source_filename: reflektive-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: searched\nprobe: true\nsource: https://ltgplc.com/trust-center/\nurl: https://ltgplc.com/trust-center/\ncertifications:\n- SOC 2\n- ISO 27001\n- GDPR\nevidence:\n- source: https://ltgplc.com/trust-center/\n  keywords:\n  - soc 2\n  - soc2\n  - iso 27001\n  - trust center\n  - gdpr\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/reflektive/refs/heads/main/security/reflektive-trust-center.yml
...
- People Analytics
- REST API
trust_url: https://ltgplc.com/trust-center/
---
