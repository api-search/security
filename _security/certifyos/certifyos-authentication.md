...
oauth_flows: []
overview: Certifyos secures its APIs with http across 1 declared security scheme, as derived from its OpenAPI definitions.
...
- bearerFormat: JWT
  ...
  scheme: bearer
  sources:
  - openapi/certify-api-service-openapi.yml
  - openapi/certify-application-openapi.json
  - openapi/certify-roster-service-openapi.yml
  type: http
slug: certifyos-authentication
source_filename: certifyos-authentication.yml
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/certifyos/refs/heads/main/authentication/certifyos-authentication.yml
