...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Aug 30 15:40:52 2026 GMT
...
overview: 'Domain security posture for InsightEra, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
