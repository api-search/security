...
- authorizationCode
- clientCredentials
overview: Khoros secures its APIs with http and oauth2 across 3 declared security schemes, as derived from its OpenAPI definitions. OAuth 2.0 is offered via the authorizationCode and clientCredentials flow(s).
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/khoros-ai/refs/heads/main/authentication/lithium-authentication.yml
