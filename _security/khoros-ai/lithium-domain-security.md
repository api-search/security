...
overview: 'Domain security posture for Khoros, probed live across 10 host(s) and 5 registrable domain(s). 10 host(s) serve HTTPS (up to TLSv1.3); 4 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
...
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/khoros-ai/refs/heads/main/security/lithium-domain-security.yml
