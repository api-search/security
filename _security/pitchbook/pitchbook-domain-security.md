...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Dec 14 00:47:13 2026 GMT
  host: pitchbook.com
  hsts: null
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for PitchBook, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: PitchBook
provider_slug: pitchbook
slug: pitchbook-domain-security
source_filename: pitchbook-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-09-21'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: pitchbook.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Dec 14 00:47:13 2026 GMT\n  hsts: null\ndomains:\n- domain: pitchbook.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/pitchbook/refs/heads/main/security/pitchbook-domain-security.yml
