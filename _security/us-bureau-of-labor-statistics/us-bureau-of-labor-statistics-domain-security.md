...
overview: 'Domain security posture for US Bureau of Labor Statistics, probed live across 2 host(s) and 1 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=reject).'
...
source_filename: us-bureau-of-labor-statistics-domain-security.yml
