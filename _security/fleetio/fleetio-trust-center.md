...
overview: Fleetio maintains a public trust center documenting SOC 2, PCI DSS, GDPR, and CSA STAR compliance.
provider_name: Fleetio
provider_slug: fleetio
slug: fleetio-trust-center
source_filename: fleetio-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: searched\nprobe: true\nsource: https://trust.fleetio.com/\nurl: https://trust.fleetio.com/\ncertifications:\n- SOC 2\n- PCI DSS\n- GDPR\n- CSA STAR\nevidence:\n- source: https://trust.fleetio.com/\n  keywords:\n  - soc 2\n  - pci dss\n  - pci-dss\n  - trust center\n  - gdpr\n  - csa star\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/fleetio/refs/heads/main/security/fleetio-trust-center.yml
