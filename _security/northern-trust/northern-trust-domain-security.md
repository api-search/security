...
- cert_expires: Feb  8 23:59:59 2027 GMT
  ...
  tls_version: TLSv1.3
- cert_expires: Feb  8 23:59:59 2027 GMT
  host: developer.ntrs.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct  4 23:59:59 2026 GMT
  host: apiservices.ntrs.com
  hsts: null
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Northern Trust, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
