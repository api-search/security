...
- cert_expires: Jan 14 23:59:59 2027 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 14 05:33:23 2026 GMT
...
overview: 'Domain security posture for Copper.co, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
provider_name: Copper.co
provider_slug: copper-co
slug: copper-co-domain-security
source_filename: copper-co-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-04'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: copper.co\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Jan 14 23:59:59 2027 GMT\n  hsts: null\n- host: developer.copper.co\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 14 05:33:23 2026 GMT\n  hsts: null\n- host: api.copper.co\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Jan 14 23:59:59 2027 GMT\n  hsts: null\ndomains:\n- domain: copper.co\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/copper-co/refs/heads/main/security/copper-co-domain-security.yml
