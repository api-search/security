...
- filename: atomicwork-businesshourconfig-api-openapi.yml
  format: yaml
  label: Atomicwork Business Hour Config API
...
overview: Atomicwork maintains a public trust center documenting SOC 2 Type 1, SOC 2 Type 2, ISO 27001, ISO 27017, ISO 27018, ISO 27701, ISO 42001, HIPAA, GDPR, CCPA, CSA STAR Level 1, Microsoft 365 Certification, and CASA Tier 3 compliance.
provider_name: Atomicwork
provider_slug: atomicwork
slug: atomicwork-trust-center
source_filename: atomicwork-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-07-18'\nmethod: searched\nprobe: true\nurl: https://trust.atomicwork.com/\ncompliance_page: https://trust.atomicwork.com/compliance\nsecurity_page: https://www.atomicwork.com/security\ncertifications:\n- SOC 2 Type 1\n- SOC 2 Type 2\n- ISO 27001\n- ISO 27017\n- ISO 27018\n- ISO 27701\n- ISO 42001\n- HIPAA\n- GDPR\n- CCPA\n- CSA STAR Level 1\n- Microsoft 365 Certification\n- CASA Tier 3\ndata_residency: Data residency options in approved regions on secure cloud infrastructure.\nevidence:\n- source: https://www.atomicwork.com/security\n  keywords: [soc 2 type 2, iso 27001, iso 42001, hipaa, gdpr, trust center]\n- source: https://trust.atomicwork.com/\n  note: Live trust center (returns 403 to automated fetchers; confirmed via security page + public announcements).\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/atomicwork/refs/heads/main/security/atomicwork-trust-center.yml
...
- MCP
- Enterprise
trust_url: https://trust.atomicwork.com/
---
