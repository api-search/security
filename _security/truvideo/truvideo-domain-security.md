...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct  1 20:51:52 2026 GMT
  host: truvideo.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for TruVideo, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: TruVideo
provider_slug: truvideo
slug: truvideo-domain-security
source_filename: truvideo-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-07-21'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: truvideo.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct  1 20:51:52 2026 GMT\n  hsts: false\ndomains:\n- domain: truvideo.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/truvideo/refs/heads/main/security/truvideo-domain-security.yml
