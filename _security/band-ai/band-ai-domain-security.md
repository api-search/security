...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Sep 16 11:05:08 2026 GMT
  host: band.ai
  hsts: null
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Band AI, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: Band AI
provider_slug: band-ai
slug: band-ai-domain-security
source_filename: band-ai-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-07-18'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: band.ai\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep 16 11:05:08 2026 GMT\n  hsts: null\ndomains:\n- domain: band.ai\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/band-ai/refs/heads/main/security/band-ai-domain-security.yml
