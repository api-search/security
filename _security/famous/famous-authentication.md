...
api_key_in: []
api_specs:
- filename: famous-internal-api-openapi.yml
  format: yaml
  label: Famous Internal API
  slug: famous-internal-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/famous/refs/heads/main/openapi/famous-internal-api-openapi.yml
- filename: famous-seller-api-openapi.yml
  format: yaml
  label: Famous Seller API
  slug: famous-seller-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/famous/refs/heads/main/openapi/famous-seller-api-openapi.yml
- filename: famous-v1-api-openapi.yml
  format: yaml
  label: Famous V1 API
  slug: famous-v1-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/famous/refs/heads/main/openapi/famous-v1-api-openapi.yml
auth_types: []
description: ''
kind: authentication
layout: security
