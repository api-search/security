...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov  4 03:17:28 2026 GMT
  host: autocontentapi.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 22 06:58:16 2026 GMT
...
overview: 'Domain security posture for AutoContent API, probed live across 2 host(s) and 1 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
