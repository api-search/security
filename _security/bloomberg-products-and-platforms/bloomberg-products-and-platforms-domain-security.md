...
overview: 'Domain security posture for Bloomberg Products and Platforms, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
...
source_filename: bloomberg-products-and-platforms-domain-security.yml
