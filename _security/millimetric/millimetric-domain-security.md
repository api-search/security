...
- cert_expires: Oct 16 03:45:17 2026 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 13 04:11:30 2026 GMT
  host: docs.millimetric.ai
  hsts: true
...
overview: 'Domain security posture for Millimetric, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC absent.'
