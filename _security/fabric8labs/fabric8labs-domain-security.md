...
- caa: []
  ...
  dmarc_policy: none
  dnssec: false
  domain: fabric8labs.com
  spf: true
hosts:
- cert_expires: Sep 15 23:00:19 2026 GMT
...
overview: 'Domain security posture for Fabric8Labs, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
provider_name: Fabric8Labs
provider_slug: fabric8labs
slug: fabric8labs-domain-security
source_filename: fabric8labs-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-12'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.fabric8labs.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep 15 23:00:19 2026 GMT\n  hsts: true\n  hsts_max_age: 63072000\ndomains:\n- domain: fabric8labs.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/fabric8labs/refs/heads/main/security/fabric8labs-domain-security.yml
