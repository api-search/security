...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Oct 19 21:15:23 2026 GMT
  host: www.explorium.ai
  hsts: true
  hsts_max_age: 15552000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 11 05:35:42 2026 GMT
  host: developers.explorium.ai
  hsts: true
  hsts_max_age: 63072000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov  9 13:00:30 2026 GMT
...
overview: 'Domain security posture for Explorium, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: Explorium
provider_slug: explorium
slug: explorium-domain-security
source_filename: explorium-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-14'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.explorium.ai\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 19 21:15:23 2026 GMT\n  hsts: true\n  hsts_max_age: 15552000\n- host: developers.explorium.ai\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov 11 05:35:42 2026 GMT\n  hsts: true\n  hsts_max_age: 63072000\n- host: mcp.explorium.ai\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov  9 13:00:30 2026 GMT\n  hsts: null\ndomains:\n- domain: explorium.ai\n  dnssec: false\n  caa:\n  - 0 issuewild \"amazon.com\"\n  - 0 issuewild \"digicert.com\"\n  - 0 issuewild \"letsencrypt.org\"\n  - 0 issuewild \"pki.goog\"\n  - 0 issue \"amazon.com\"\n  - 0 issue \"digicert.com\"\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/explorium/refs/heads/main/security/explorium-domain-security.yml
