...
- body
api_specs:
- filename: novicap-confirming-standard-api-openapi.yml
  format: yaml
  label: Novicap Confirming Standard API
  slug: novicap-confirming-standard-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/novicap/refs/heads/main/openapi/novicap-confirming-standard-api-openapi.yml
- filename: novicap-dynamic-discounting-api-openapi.yml
  format: yaml
  label: Novicap Dynamic Discounting API
  slug: novicap-dynamic-discounting-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/novicap/refs/heads/main/openapi/novicap-dynamic-discounting-api-openapi.yml
auth_types:
- http
- oauth2
description: ''
