...
overview: 'Domain security posture for Offendersearch API, probed live across 2 host(s) and 1 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
provider_name: Offendersearch API
provider_slug: offendersearch-api
slug: offendersearch-api-domain-security
source_filename: offendersearch-api-domain-security.yml
