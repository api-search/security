...
- caa: []
  ...
  dmarc_policy: reject
  dnssec: false
  domain: tokamakenergy.com
  spf: true
hosts:
- cert_expires: Nov 15 09:16:34 2026 GMT
  host: tokamakenergy.com
  hsts: false
  https: true
  tls_version: TLSv1.3
hosts_probed: 1
...
overview: 'Domain security posture for Tokamak Energy, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Tokamak Energy
provider_slug: tokamak-energy
slug: tokamak-energy-domain-security
source_filename: tokamak-energy-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-30'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: tokamakenergy.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov 15 09:16:34 2026 GMT\n  hsts: false\ndomains:\n- domain: tokamakenergy.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/tokamak-energy/refs/heads/main/security/tokamak-energy-domain-security.yml
