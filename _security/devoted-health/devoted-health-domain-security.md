...
overview: 'Domain security posture for Devoted Health, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=quarantine).'
provider_name: Devoted Health
provider_slug: devoted-health
slug: devoted-health-domain-security
source_filename: devoted-health-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-07-18'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: devoted.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct  1 23:59:59 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: www.devoted.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct  1 23:59:59 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: api.prod.devoted.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Aug 18 15:16:55 2026 GMT\n  hsts: null\ndomains:\n- domain: devoted.com\n  dnssec: true\n  caa:\n  - 128 issue \"amazonaws.com\"\n  - 128 issue \"digicert.com\"\n  - 128 issue \"letsencrypt.org;validationmethods=dns-01;accounturi=https://acme-v02.api.letsencrypt.org/acme/acct/2119334475\"\n  - 128 issue \"letsencrypt.org;validationmethods=dns-01;accounturi=https://acme-v02.api.letsencrypt.org/acme/acct/88814841\"\n  - 128 issue \"sectigo.com\"\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/devoted-health/refs/heads/main/security/devoted-health-domain-security.yml
