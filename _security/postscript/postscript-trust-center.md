...
overview: Postscript maintains a public trust center documenting SOC 2 and GDPR compliance.
provider_name: Postscript
provider_slug: postscript
slug: postscript-trust-center
source_filename: postscript-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-08-13'\nmethod: searched\nprobe: true\nsource: https://trust.postscript.io/\nurl: https://trust.postscript.io/\ncertifications:\n- SOC 2\n- GDPR\nevidence:\n- source: https://trust.postscript.io/\n  keywords:\n  - soc 2\n  - soc2\n  - trust center\n  - gdpr\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/postscript/refs/heads/main/security/postscript-trust-center.yml
