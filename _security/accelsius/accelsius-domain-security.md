...
- caa: []
  ...
  dmarc_policy: none
  dnssec: false
  domain: accelsius.com
  spf: true
hosts:
- cert_expires: Oct 15 09:00:21 2026 GMT
  host: accelsius.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Accelsius, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
provider_name: Accelsius
provider_slug: accelsius
slug: accelsius-domain-security
source_filename: accelsius-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-06'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: accelsius.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 15 09:00:21 2026 GMT\n  hsts: false\ndomains:\n- domain: accelsius.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/accelsius/refs/heads/main/security/accelsius-domain-security.yml
