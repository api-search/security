...
layout: security
method: probed
name: Clearwater Paper Domain Security
name_suffix: Domain Security
overview: 'Domain security posture for Clearwater Paper, probed live across 3 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: Clearwater Paper
provider_slug: clearwater-paper
slug: clearwater-paper-domain-security
