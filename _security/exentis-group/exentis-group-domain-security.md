...
- caa: []
  ...
  dnssec: false
  domain: exentis-group.com
  spf: true
hosts:
- cert_expires: Nov 10 04:09:39 2026 GMT
  host: www.exentis-group.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Exentis Group, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: Exentis Group
provider_slug: exentis-group
slug: exentis-group-domain-security
source_filename: exentis-group-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-12'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.exentis-group.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov 10 04:09:39 2026 GMT\n  hsts: false\ndomains:\n- domain: exentis-group.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/exentis-group/refs/heads/main/security/exentis-group-domain-security.yml
