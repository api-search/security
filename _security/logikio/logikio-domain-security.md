...
- cert_expires: Feb  7 23:59:59 2027 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Sep 19 21:48:18 2026 GMT
  host: api-docs.logik.io
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Logik.io, probed live across 2 host(s) and 1 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=quarantine).'
