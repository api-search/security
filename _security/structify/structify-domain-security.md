...
- cert_expires: Oct 14 04:45:09 2026 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov  1 04:58:40 2026 GMT
...
overview: 'Domain security posture for Structify, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
