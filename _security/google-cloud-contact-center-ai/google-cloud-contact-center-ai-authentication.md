...
oauth_flows:
- authorizationCode
overview: Google Cloud Contact Center AI secures its APIs with oauth2 across 1 declared security scheme, as derived from its OpenAPI definitions. OAuth 2.0 is offered via the authorizationCode flow(s).
...
source_filename: google-cloud-contact-center-ai-authentication.yml
