---
api_specs:
- filename: zoho-invoice-openapi.yml
  format: yaml
  label: Zoho Invoice API
  slug: api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/zoho-invoice/refs/heads/main/openapi/zoho-invoice-openapi.yml
description: ''
domains:
- caa:
  - 0 issue "sectigo.com"
