...
- cert_expires: Jan 16 23:59:59 2027 GMT
  ...
  https: true
  tls_version: TLSv1.2
- cert_expires: Nov 10 15:50:16 2026 GMT
  host: wonder.cdc.gov
  hsts: null
  https: true
  tls_version: TLSv1.2
...
overview: 'Domain security posture for Centers for Disease Control and Prevention, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.2); 1 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=reject).'
