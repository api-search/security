...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Aug 30 01:33:51 2026 GMT
  host: www.g2.com
  hsts: true
...
overview: 'Domain security posture for Business Software and Services Reviews | G2, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 3 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
