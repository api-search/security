...
- filename: hashicorp-vault-policies-api-openapi.yml
  format: yaml
  label: HashiCorp Vault Policies API
  slug: hashicorp-vault-policies-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/hashicorp-vault/refs/heads/main/openapi/hashicorp-vault-policies-api-openapi.yml
- filename: hashicorp-vault-secrets-config-api-openapi.yml
  format: yaml
  label: HashiCorp Vault Secrets Config API
  slug: hashicorp-vault-secrets-config-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/hashicorp-vault/refs/heads/main/openapi/hashicorp-vault-secrets-config-api-openapi.yml
- filename: hashicorp-vault-secrets-data-api-openapi.yml
  format: yaml
  label: HashiCorp Vault Secrets Data API
  slug: hashicorp-vault-secrets-data-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/hashicorp-vault/refs/heads/main/openapi/hashicorp-vault-secrets-data-api-openapi.yml
- filename: hashicorp-vault-secrets-metadata-api-openapi.yml
  format: yaml
  label: HashiCorp Vault Secrets Metadata API
  slug: hashicorp-vault-secrets-metadata-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/hashicorp-vault/refs/heads/main/openapi/hashicorp-vault-secrets-metadata-api-openapi.yml
auth_types:
- apiKey
description: ''
kind: authentication
