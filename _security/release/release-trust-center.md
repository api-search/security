...
overview: Release maintains a public trust center documenting SOC 2 compliance.
provider_name: Release
provider_slug: release
slug: release-trust-center
source_filename: release-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-07-21'\nmethod: searched\nprobe: true\nsource: https://release.com/legal/security\nurl: https://release.com/legal/security\ncertifications:\n- SOC 2\nevidence:\n- source: https://release.com/legal/security\n  keywords:\n  - soc 2\n  - compliance certification\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/release/refs/heads/main/security/release-trust-center.yml
summary_line: SOC 2
tags:
- Company
- Developer Tools
...
- CI/CD
- AI Sandbox
trust_url: https://release.com/legal/security
---
