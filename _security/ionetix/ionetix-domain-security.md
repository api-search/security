...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Sep 25 19:02:57 2026 GMT
  host: ionetix.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Ionetix, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
provider_name: Ionetix
provider_slug: ionetix
slug: ionetix-domain-security
source_filename: ionetix-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-23'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: ionetix.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep 25 19:02:57 2026 GMT\n  hsts: false\ndomains:\n- domain: ionetix.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/ionetix/refs/heads/main/security/ionetix-domain-security.yml
