...
overview: Button maintains a public trust center documenting SOC 2 and GDPR compliance.
provider_name: Button
provider_slug: usebutton
slug: usebutton-trust-center
source_filename: usebutton-trust-center.yml
source_heading: Trust Center
source_url: ''
source_yaml: "generated: '2026-07-21'\nmethod: searched\nprobe: true\nsource: https://www.usebutton.com/support/security\nurl: https://www.usebutton.com/support/security\ncertifications:\n- SOC 2\n- GDPR\nevidence:\n- source: https://www.usebutton.com/support/security\n  keywords:\n  - soc2\n  - gdpr\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/usebutton/refs/heads/main/security/usebutton-trust-center.yml
...
- Publishers
- Retail
trust_url: https://www.usebutton.com/support/security
---
