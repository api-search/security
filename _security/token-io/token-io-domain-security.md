...
- cert_expires: Apr  2 23:59:59 2027 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 12 15:51:41 2026 GMT
  host: docs.token.io
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Token.io, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
