...
- caa: []
  ...
  dnssec: false
  domain: effectphotonics.com
  spf: true
hosts:
- cert_expires: Nov  1 21:42:28 2026 GMT
  host: effectphotonics.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for EFFECT Photonics, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: EFFECT Photonics
provider_slug: effect-photonics
slug: effect-photonics-domain-security
source_filename: effect-photonics-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-12'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: effectphotonics.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov  1 21:42:28 2026 GMT\n  hsts: false\ndomains:\n- domain: effectphotonics.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/effect-photonics/refs/heads/main/security/effect-photonics-domain-security.yml
