...
- caa: []
  dmarc: false
  dnssec: false
  domain: apigateway.co
  spf: false
hosts:
- cert_expires: Oct 22 10:00:57 2026 GMT
...
- cert_expires: Oct  6 01:24:26 2026 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 23 16:34:42 2026 GMT
...
overview: 'Domain security posture for Vendasta, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
