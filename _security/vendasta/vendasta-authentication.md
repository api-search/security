...
overview: Vendasta secures its APIs with oauth2, http, and openIdConnect across 6 declared security schemes, as derived from its OpenAPI definitions. OAuth 2.0 is offered via the authorizationCode and jwt-bearer-assertion flow(s).
