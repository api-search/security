...
mechanism_count: 2
method: searched
name: Freddie Mac Authentication
name_suffix: Authentication
oauth_flows: []
overview: Freddie Mac secures its APIs with http across 2 declared security schemes, as derived from its OpenAPI definitions.
...
- name: basicAuth
  ...
  type: http
slug: freddie-mac-authentication
source_filename: freddie-mac-authentication.yml
