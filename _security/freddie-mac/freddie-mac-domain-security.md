...
- cert_expires: Oct 17 23:59:59 2026 GMT
  host: developer.freddiemac.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Feb 25 23:59:59 2027 GMT
  host: api-test.freddiemac.com
  hsts: null
  https: true
  tls_version: TLSv1.3
hosts_probed: 3
...
overview: 'Domain security posture for Freddie Mac, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=quarantine).'
