...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov 10 19:07:02 2026 GMT
  host: www.unifygtm.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 21 09:11:02 2026 GMT
...
overview: 'Domain security posture for Unify, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Unify
provider_slug: unify
