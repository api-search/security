...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct 19 20:23:48 2026 GMT
  host: www.sigmacomputing.com
  hsts: true
  hsts_max_age: 63072000
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct  5 23:36:22 2026 GMT
  host: help.sigmacomputing.com
  hsts: true
  hsts_max_age: 63072000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 24 21:50:21 2026 GMT
  host: api.sigmacomputing.com
  hsts: null
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Sigma Computing, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=quarantine).'
provider_name: Sigma Computing
provider_slug: sigma-computing
slug: sigma-computing-domain-security
source_filename: sigma-computing-domain-security.yml
