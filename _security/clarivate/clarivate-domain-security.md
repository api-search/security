...
- caa: []
  ...
  spf: false
hosts:
- cert_expires: Nov 21 10:07:26 2026 GMT
  host: clarivate.com
  hsts: true
...
- cert_expires: Mar 19 23:59:59 2027 GMT
  ...
  https: true
  tls_version: TLSv1.2
- cert_expires: Oct 23 04:27:51 2026 GMT
...
overview: 'Domain security posture for Clarivate, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
