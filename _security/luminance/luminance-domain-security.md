...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct 30 14:07:01 2026 GMT
  host: www.luminance.com
  hsts: true
  hsts_max_age: 63072000
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 30 14:07:01 2026 GMT
  host: api.luminance.com
  hsts: true
  hsts_max_age: 2592000
  https: true
  tls_version: TLSv1.3
- host: your-instance.app.luminance.com
  https: false
...
overview: 'Domain security posture for Luminance, probed live across 3 host(s) and 1 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
provider_name: Luminance
provider_slug: luminance
slug: luminance-domain-security
source_filename: luminance-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-04'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.luminance.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 30 14:07:01 2026 GMT\n  hsts: true\n  hsts_max_age: 63072000\n- host: api.luminance.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 30 14:07:01 2026 GMT\n  hsts: true\n  hsts_max_age: 2592000\n- host: your-instance.app.luminance.com\n  https: false\ndomains:\n- domain: luminance.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: none\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/luminance/refs/heads/main/security/luminance-domain-security.yml
