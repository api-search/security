...
- filename: scalar-docs-projects-api-openapi.yml
  format: yaml
  label: Scalar Docs Projects API
  slug: scalar-docs-projects-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/scalar/refs/heads/main/openapi/scalar-docs-projects-api-openapi.yml
- filename: scalar-forgejo-api-openapi.yml
  format: yaml
  label: Scalar Forgejo API
  slug: scalar-forgejo-api
  spec_type: OpenAPI
...
- filename: scalar-internal-api-openapi.yml
  format: yaml
  label: Scalar Internal API
  slug: scalar-internal-api
  spec_type: OpenAPI
...
kind: trust-center
layout: security
name: Scalar Trust Center
name_suffix: Trust Center
overview: Scalar maintains a public trust center documenting SOC 2 and GDPR compliance.
provider_name: Scalar
provider_slug: scalar
slug: scalar-trust-center
