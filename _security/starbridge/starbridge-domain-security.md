...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct 30 23:53:18 2026 GMT
  host: starbridge.ai
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Sep 28 09:13:06 2026 GMT
  host: hc.starbridge.ai
  hsts: true
  hsts_max_age: 63072000
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 16 22:37:47 2026 GMT
  host: dashboard.starbridge.ai
  hsts: true
...
overview: 'Domain security posture for Starbridge, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
