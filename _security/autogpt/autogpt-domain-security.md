...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Aug 30 18:53:39 2026 GMT
  host: agpt.co
  hsts: true
...
overview: 'Domain security posture for AutoGPT, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=none).'
