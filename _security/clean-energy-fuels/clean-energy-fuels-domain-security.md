...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov  2 16:16:00 2026 GMT
  host: cleanenergyfuels.com
  hsts: true
...
overview: 'Domain security posture for Clean Energy Fuels, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
