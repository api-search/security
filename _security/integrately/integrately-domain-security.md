...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov 22 05:35:16 2026 GMT
  host: www.integrately.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Dec  1 15:32:05 2026 GMT
  host: integrately.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 12 04:47:49 2026 GMT
...
overview: 'Domain security posture for Integrately, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
