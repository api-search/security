...
- caa: []
  ...
  dmarc_policy: none
  dnssec: true
  domain: mydentify.com
  spf: false
hosts:
- cert_expires: Oct  7 03:21:04 2026 GMT
  host: mydentify.com
  hsts: true
...
overview: 'Domain security posture for Mydentify Public API, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC present, SPF absent, DMARC present (p=none).'
provider_name: Mydentify Public API
provider_slug: mydentify-public-api
slug: mydentify-public-api-domain-security
source_filename: mydentify-public-api-domain-security.yml
