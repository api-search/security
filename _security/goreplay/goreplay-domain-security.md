...
- caa: []
  ...
  spf: false
hosts:
- cert_expires: Aug 30 16:02:18 2026 GMT
  host: goreplay.org
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for GoReplay, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF absent, DMARC absent.'
