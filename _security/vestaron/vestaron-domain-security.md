...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Sep 27 21:36:47 2026 GMT
  host: vestaron.com
  hsts: false
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Vestaron, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
provider_name: Vestaron
provider_slug: vestaron
slug: vestaron-domain-security
source_filename: vestaron-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-05'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: vestaron.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep 27 21:36:47 2026 GMT\n  hsts: false\ndomains:\n- domain: vestaron.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/vestaron/refs/heads/main/security/vestaron-domain-security.yml
