...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Nov 23 07:05:59 2026 GMT
...
overview: 'Domain security posture for Minerals Technologies, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
