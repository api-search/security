...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Oct 21 06:30:54 2026 GMT
  host: tracxn.com
  hsts: true
...
overview: 'Domain security posture for Tracxn, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
