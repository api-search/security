...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Aug 27 14:00:10 2026 GMT
  host: datarobot.com
  hsts: true
...
overview: 'Domain security posture for DataRobot, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
