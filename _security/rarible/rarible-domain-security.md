...
- caa: []
  ...
  spf: false
hosts:
- cert_expires: Oct  8 23:36:12 2026 GMT
  host: rarible.com
  hsts: true
  hsts_max_age: 15552000
  https: true
  tls_version: TLSv1.3
- cert_expires: Sep 24 15:09:45 2026 GMT
  host: rarible.org
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Sep 21 12:57:55 2026 GMT
  host: api.rarible.org
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
...
layout: security
method: probed
name: Rarible Domain Security
name_suffix: Domain Security
overview: 'Domain security posture for Rarible, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 3 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Rarible
provider_slug: rarible
slug: rarible-domain-security
source_filename: rarible-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: rarible.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct  8 23:36:12 2026 GMT\n  hsts: true\n  hsts_max_age: 15552000\n- host: rarible.org\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep 24 15:09:45 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\n- host: api.rarible.org\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep 21 12:57:55 2026 GMT\n  hsts: true\n  hsts_max_age: 31536000\ndomains:\n- domain: rarible.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n- domain: rarible.org\n  dnssec: false\n  caa: []\n  spf: false\n  dmarc: false\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/rarible/refs/heads/main/security/rarible-domain-security.yml
