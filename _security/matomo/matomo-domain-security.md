...
- cert_expires: Oct  4 23:59:59 2026 GMT
  host: demo-proxy.innocraft.cloud
  hsts: true
...
overview: 'Domain security posture for Matomo, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 3 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
