...
- caa: []
  ...
  dmarc_policy: reject
  dnssec: false
  domain: thelivekindlyco.com
  spf: true
hosts:
- cert_expires: Sep  5 22:48:50 2026 GMT
...
overview: 'Domain security posture for LIVEKINDLY, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: LIVEKINDLY
provider_slug: livekindly
slug: livekindly-domain-security
source_filename: livekindly-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-04'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: thelivekindlyco.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Sep  5 22:48:50 2026 GMT\n  hsts: false\ndomains:\n- domain: thelivekindlyco.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/livekindly/refs/heads/main/security/livekindly-domain-security.yml
