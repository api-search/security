...
- caa:
  ...
  spf: true
hosts:
- cert_expires: Nov  1 18:45:25 2026 GMT
  host: ibanforge.com
  hsts: true
  hsts_max_age: 63072000
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 31 09:12:07 2026 GMT
...
overview: 'Domain security posture for IBANforge, probed live across 2 host(s) and 1 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=reject).'
