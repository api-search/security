...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct  6 23:11:40 2026 GMT
  host: www.enrich.so
  hsts: null
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 23 00:06:27 2026 GMT
  host: doc.enrich.so
  hsts: false
  https: true
  tls_version: TLSv1.2
- cert_expires: Nov  6 15:16:36 2026 GMT
  host: dev.enrich.so
  hsts: null
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Enrich, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Enrich
provider_slug: enrich-so
slug: enrich-so-domain-security
source_filename: enrich-so-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-14'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: www.enrich.so\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct  6 23:11:40 2026 GMT\n  hsts: null\n- host: doc.enrich.so\n  https: true\n  tls_version: TLSv1.2\n  cert_expires: Oct 23 00:06:27 2026 GMT\n  hsts: false\n- host: dev.enrich.so\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Nov  6 15:16:36 2026 GMT\n  hsts: null\ndomains:\n- domain: enrich.so\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/enrich-so/refs/heads/main/security/enrich-so-domain-security.yml
