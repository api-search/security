...
- cert_expires: Feb 20 23:59:59 2027 GMT
  host: totalview.healthos.elevancehealth.com
  hsts: null
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for Anthem, probed live across 3 host(s) and 2 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
