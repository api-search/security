---
api_specs:
- filename: meshy-image-to-3d-api-openapi.yml
  format: yaml
  label: Meshy Image to 3D API
  slug: meshy-image-to-3d-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/meshy/refs/heads/main/openapi/meshy-image-to-3d-api-openapi.yml
- filename: meshy-text-to-3d-api-openapi.yml
  format: yaml
  label: Meshy Text to 3D API
  slug: meshy-text-to-3d-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/meshy/refs/heads/main/openapi/meshy-text-to-3d-api-openapi.yml
description: ''
domains:
- caa: []
  dmarc: true
