...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Sep  5 04:41:51 2026 GMT
  host: stotles.com
  hsts: true
...
overview: 'Domain security posture for Stotles, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
