...
scheme_count: 2
schemes:
- description: 'API key issued from your MyShipTracking account page, passed as `Authorization: Bearer YOUR_API_KEY`. Register a free account at MyShipTracking.com, then generate your API Key and Secret Key on the account page. Each user may hold one trial key (2,000 coins, 10 days).'
  in: header
  name: bearerAuth
  scheme: bearer
  sources:
