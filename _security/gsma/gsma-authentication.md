...
oauth_flows: []
overview: GSMA secures its APIs with http, openIdConnect, and unknown across 3 declared security schemes, as derived from its OpenAPI definitions.
provider_name: GSMA
provider_slug: gsma
scheme_count: 3
schemes:
...
source_filename: gsma-authentication.yml
