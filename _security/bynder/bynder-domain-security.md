...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct 10 17:20:06 2026 GMT
  host: www.bynder.com
  hsts: true
...
overview: 'Domain security posture for Bynder, probed live across 3 host(s) and 1 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
