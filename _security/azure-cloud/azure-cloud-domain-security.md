...
overview: 'Domain security posture for Microsoft Azure Cloud, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
provider_name: Microsoft Azure Cloud
provider_slug: azure-cloud
slug: azure-cloud-domain-security
source_filename: azure-cloud-domain-security.yml
