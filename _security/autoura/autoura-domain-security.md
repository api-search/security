...
- cert_expires: Oct 17 08:01:02 2026 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Jan 16 14:16:46 2027 GMT
  host: api.autoura.com
  hsts: null
  https: true
  tls_version: TLSv1.2
hosts_probed: 2
...
overview: 'Domain security posture for Autoura, probed live across 2 host(s) and 1 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC absent.'
