...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct  2 18:29:31 2026 GMT
...
overview: 'Domain security posture for Incus, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=quarantine).'
provider_name: Incus
provider_slug: incus
slug: incus-domain-security
source_filename: incus-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-07-11'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: linuxcontainers.org\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct  2 18:29:31 2026 GMT\n  hsts: false\ndomains:\n- domain: linuxcontainers.org\n  dnssec: true\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: quarantine\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/incus/refs/heads/main/security/incus-domain-security.yml
