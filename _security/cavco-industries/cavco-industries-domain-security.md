...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Dec  4 02:02:06 2026 GMT
  host: www.cavco.com
  hsts: true
...
overview: 'Domain security posture for Cavco Industries, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=none).'
