...
- cert_expires: Sep 15 20:47:22 2026 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 11 10:19:11 2026 GMT
...
overview: 'Domain security posture for Reputation, probed live across 3 host(s) and 2 registrable domain(s). 2 host(s) serve HTTPS (up to TLSv1.3); 2 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
