...
- cert_expires: Oct  7 15:20:34 2026 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Dec  1 19:08:41 2026 GMT
  host: docs.budibase.com
  hsts: true
  hsts_max_age: 31536000
  https: true
  tls_version: TLSv1.3
- cert_expires: Nov 15 23:29:13 2026 GMT
  host: budibase.app
  hsts: true
  hsts_max_age: 31536000
  https: true
...
overview: 'Domain security posture for Budibase, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 3 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
