...
- query
api_specs:
- filename: us-dot-aircarrierapi-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Air Carrier API
  slug: us-dot-aircarrierapi-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-aircarrierapi-api-openapi.yml
- filename: us-dot-axhsubmitdiscrepancies-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Axhsubmitdiscrepancies API
  slug: us-dot-axhsubmitdiscrepancies-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-axhsubmitdiscrepancies-api-openapi.yml
- filename: us-dot-coded-instrument-flight-procedures-cifp-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Coded Instrument Flight Procedures (CIFP) API
  slug: us-dot-coded-instrument-flight-procedures-cifp-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-coded-instrument-flight-procedures-cifp-api-openapi.yml
- filename: us-dot-daily-digital-obstacle-file-ddof-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Daily Digital Obstacle File (DDOF) API
  slug: us-dot-daily-digital-obstacle-file-ddof-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-daily-digital-obstacle-file-ddof-api-openapi.yml
- filename: us-dot-digital-enroute-charts-us-ddecus-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Digital Enroute Charts US (DDECUS) API
  slug: us-dot-digital-enroute-charts-us-ddecus-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-digital-enroute-charts-us-ddecus-api-openapi.yml
- filename: us-dot-digital-enroute-supplement-ders-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Digital Enroute Supplement (DERS) API
  slug: us-dot-digital-enroute-supplement-ders-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-digital-enroute-supplement-ders-api-openapi.yml
- filename: us-dot-faa-airport-status-service-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation FAA Airport Status Service API
  slug: us-dot-faa-airport-status-service-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-faa-airport-status-service-api-openapi.yml
- filename: us-dot-grand-canyon-vfr-chart-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Grand Canyon VFR Chart API
  slug: us-dot-grand-canyon-vfr-chart-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-grand-canyon-vfr-chart-api-openapi.yml
- filename: us-dot-gulf-of-mexico-ifr-enroute-chart-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Gulf of Mexico IFR Enroute Chart API
  slug: us-dot-gulf-of-mexico-ifr-enroute-chart-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-gulf-of-mexico-ifr-enroute-chart-api-openapi.yml
- filename: us-dot-ifr-enroute-charts-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation IFR Enroute Charts API
  slug: us-dot-ifr-enroute-charts-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-ifr-enroute-charts-api-openapi.yml
- filename: us-dot-ifr-planning-charts-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation IFR Planning Charts API
  slug: us-dot-ifr-planning-charts-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-ifr-planning-charts-api-openapi.yml
- filename: us-dot-log-file-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation log file API
  slug: us-dot-log-file-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-log-file-api-openapi.yml
- filename: us-dot-nasr-28-day-subscription-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation NASR 28 Day Subscription API
  slug: us-dot-nasr-28-day-subscription-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-nasr-28-day-subscription-api-openapi.yml
- filename: us-dot-oceanic-route-charts-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Oceanic Route Charts API
  slug: us-dot-oceanic-route-charts-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-oceanic-route-charts-api-openapi.yml
- filename: us-dot-pdm-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation PDM API
  slug: us-dot-pdm-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-pdm-api-openapi.yml
- filename: us-dot-sectional-charts-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Sectional Charts API
  slug: us-dot-sectional-charts-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-sectional-charts-api-openapi.yml
- filename: us-dot-snmp-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation SNMP API
  slug: us-dot-snmp-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-snmp-api-openapi.yml
- filename: us-dot-supplement-chart-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Supplement Chart API
  slug: us-dot-supplement-chart-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-supplement-chart-api-openapi.yml
- filename: us-dot-terminal-area-charts-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Terminal Area Charts API
  slug: us-dot-terminal-area-charts-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-terminal-area-charts-api-openapi.yml
- filename: us-dot-tim-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation TIM API
  slug: us-dot-tim-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-tim-api-openapi.yml
- filename: us-dot-us-terminal-procedures-publication-tpp-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation US Terminal Procedures Publication (TPP) API
  slug: us-dot-us-terminal-procedures-publication-tpp-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-us-terminal-procedures-publication-tpp-api-openapi.yml
- filename: us-dot-us-vfr-wall-planning-chart-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation US VFR Wall Planning Chart API
  slug: us-dot-us-vfr-wall-planning-chart-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-us-vfr-wall-planning-chart-api-openapi.yml
- filename: us-dot-version-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation Version API
  slug: us-dot-version-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/us-dot/refs/heads/main/openapi/us-dot-version-api-openapi.yml
- filename: us-dot-vfr-helicopter-route-chart-api-openapi.yml
  format: yaml
  label: U.S. Department of Transportation VFR Helicopter Route Chart API
