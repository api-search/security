...
scheme_count: 1
schemes:
- description: Authenticate using an API key or OAuth access token. Include the token in the Authorization header as "Bearer [example key]".
  name: bearerAuth
  scheme: bearer
  sources:
