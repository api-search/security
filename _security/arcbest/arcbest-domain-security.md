...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Oct 22 09:36:12 2026 GMT
  host: www.arcbest.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Oct 18 18:58:58 2026 GMT
  host: arcb.com
  hsts: false
  https: true
  tls_version: TLSv1.3
- cert_expires: Dec 11 16:09:16 2026 GMT
  host: api.arcb.com
  hsts: null
  https: true
  tls_version: TLSv1.2
...
overview: 'Domain security posture for ArcBest, probed live across 3 host(s) and 2 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
