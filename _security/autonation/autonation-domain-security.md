...
- caa: []
  ...
  spf: true
hosts:
- cert_expires: Dec  4 01:01:58 2026 GMT
...
overview: 'Domain security posture for AutoNation, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=quarantine).'
