...
- cert_expires: Jan 22 23:59:59 2027 GMT
  ...
  https: true
  tls_version: TLSv1.3
- cert_expires: Sep  9 20:12:51 2026 GMT
  host: refdata.api.cmegroup.com
  hsts: null
  https: true
  tls_version: TLSv1.3
...
overview: 'Domain security posture for CME Group, probed live across 3 host(s) and 1 registrable domain(s). 3 host(s) serve HTTPS (up to TLSv1.3); 1 advertise HSTS. Email/DNS controls: DNSSEC present, SPF present, DMARC present (p=reject).'
