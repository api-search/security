...
- filename: creed-admin-analytics-api-openapi.yml
  format: yaml
  label: Creed Admin Analytics API
  slug: creed-admin-analytics-api
  spec_type: OpenAPI
  url: https://raw.githubusercontent.com/api-evangelist/creed/refs/heads/main/openapi/creed-admin-analytics-api-openapi.yml
- filename: creed-auth-api-openapi.yml
  format: yaml
  label: Creed Auth API
  slug: creed-auth-api
  spec_type: OpenAPI
...
- filename: creed-email-notifications-api-openapi.yml
  format: yaml
  label: Creed Email Notifications API
  slug: creed-email-notifications-api
  spec_type: OpenAPI
