...
- caa: []
  ...
  dmarc_policy: reject
  dnssec: false
  domain: impulse-dynamics.com
  spf: true
hosts:
- cert_expires: Oct 22 05:02:47 2026 GMT
  host: impulse-dynamics.com
  hsts: false
  https: true
  tls_version: TLSv1.3
hosts_probed: 1
...
overview: 'Domain security posture for Impulse Dynamics, probed live across 1 host(s) and 1 registrable domain(s). 1 host(s) serve HTTPS (up to TLSv1.3); 0 advertise HSTS. Email/DNS controls: DNSSEC absent, SPF present, DMARC present (p=reject).'
provider_name: Impulse Dynamics
provider_slug: impulse-dynamics
slug: impulse-dynamics-domain-security
source_filename: impulse-dynamics-domain-security.yml
source_heading: Domain Security
source_url: ''
source_yaml: "generated: '2026-08-23'\nmethod: probed\nsource: live DNS/TLS/HTTP probes of apis.yml + OpenAPI hosts\nhosts:\n- host: impulse-dynamics.com\n  https: true\n  tls_version: TLSv1.3\n  cert_expires: Oct 22 05:02:47 2026 GMT\n  hsts: false\ndomains:\n- domain: impulse-dynamics.com\n  dnssec: false\n  caa: []\n  spf: true\n  dmarc: true\n  dmarc_policy: reject\n"
source_yaml_url: https://raw.githubusercontent.com/api-evangelist/impulse-dynamics/refs/heads/main/security/impulse-dynamics-domain-security.yml
